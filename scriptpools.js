...
export const HealthIssuesPool = {
  health: [
    ...
    {
      issue: "Heart disease",
      title: "Plant-Based Diet for Heart Health",
      content: "A plant-based diet rich in fruits, vegetables, whole grains, and legumes helps reduce cholesterol levels and supports heart health.",
      quiz: {
        question: "Which foods are emphasized in a heart-healthy plant-based diet?",
        options: [
          "Red meat and butter",
          "Fruits, vegetables, whole grains, and legumes",
          "Sugary snacks and fried foods",
    ...
    {
      issue: "Heart disease",
      title: "Lowering Blood Pressure Naturally",
      content: "Reducing saturated fats and incorporating nuts, seeds, and olive oil can lower blood pressure and support cardiovascular health.",
      quiz: {
        question: "Which foods can help lower blood pressure naturally?",
        options: [
    ...
    // High cholesterol
    {
      ...
      content: "Eating more soluble fiber from oats, beans, and fruits can reduce LDL cholesterol and support overall heart health.",
      quiz: {
        question: "Which food is rich in soluble fiber and helps reduce LDL cholesterol?",
        options: [
          "Oats",
          "Bacon",
          "Butter",
    ...
    {
      issue: "High cholesterol",
      title: "Replace Animal Fats",
      content: "Replacing animal fats with plant-based oils and eating more vegetables can help maintain healthy cholesterol levels.",
      quiz: {
        question: "What should animal fats be replaced with to maintain healthy cholesterol?",
        options: [
          "Plant-based oils",
          "Processed snacks",
          "Sugary drinks",
    ...
    // High blood pressure
    {
      ...
      content: "Reducing sodium intake and eating potassium-rich foods like bananas, spinach, and sweet potatoes can help lower blood pressure naturally.",
      quiz: {
        question: "Which of these foods is rich in potassium?",
        options: [
          "Bananas and spinach",
          "Processed chips",
          "Soda",
    ...
    {
      issue: "High blood pressure",
      title: "Healthy Lifestyle for BP",
      content: "Plant-based diets, stress management, and regular exercise contribute to maintaining healthy blood pressure.",
      quiz: {
        question: "Which lifestyle choices help maintain healthy blood pressure?",
        options: [
    ...
    // Type 2 diabetes
    {
      ...
      title: "Low-Glycemic Plant Foods",
      content: "Consuming low-glycemic plant foods like whole grains, legumes, and vegetables helps stabilize blood sugar and reduce the risk of type 2 diabetes.",
      quiz: {
    ...
    {
      issue: "Type 2 diabetes",
      title: "Sugar Reduction & Fiber",
      content: "Replacing sugary drinks with water, increasing fiber intake, and maintaining a balanced diet improves insulin sensitivity and overall health.",
      quiz: {
    ...
    {
      issue: "Obesity",
      title: "Whole Plant Foods & Portion Control",
      content: "Eating a variety of whole plant foods and controlling portion sizes helps maintain a healthy weight and reduces obesity risk.",
      quiz: {
        question: "What helps reduce obesity risk?",
        options: [
          "Whole plant foods and portion control",
    ...
    {
      issue: "Obesity",
      title: "Exercise & Plant-Based Nutrition",
      content: "Regular physical activity combined with plant-based nutrition promotes healthy metabolism and long-term weight management.",
      quiz: {
        question: "What combination supports long-term weight management?",
        options: [
          "Exercise and plant-based nutrition",
          "Sedentary lifestyle and fast food",
          "Skipping meals and soda",
          "Only eating meat"
        ],
        answer: 0
      }
    ...
    // Digestive issues
    {
      ...
      content: "A high-fiber diet from fruits, vegetables, and whole grains promotes regular digestion and gut health.",
      quiz: {
        question: "Which diet supports regular digestion?",
        options: [
          "High-fiber diet from fruits, vegetables, and grains",
          "Low-fiber diet with processed food",
          "Sugary snacks",
          "Dairy-heavy diet"
        ],
        answer: 0
    ...
    },
    {
      ...
      content: "Probiotics from fermented plant foods, like sauerkraut, kimchi, and plant yogurt, support a healthy gut microbiome.",
      quiz: {
    ...
    // Inflammation or swelling
    {
      ...
      content: "Plant-based foods rich in antioxidants, like berries, leafy greens, and nuts, help reduce inflammation in the body.",
      quiz: {
    ...
    },
    {
      ...
      content: "Avoiding processed foods, sugar, and excessive refined carbs helps prevent chronic inflammation.",
      quiz: {
    ...
    {
      issue: "Fatigue",
      title: "Nutrient-Dense Foods & Hydration",
      content: "Eating nutrient-dense plant foods and staying hydrated supports energy levels and reduces fatigue.",
      quiz: {
        question: "What supports energy levels and reduces fatigue?",
        options: [
    ...
    {
      issue: "Fatigue",
      title: "Balance Micronutrients",
      content: "Balancing iron, vitamin B12, and complex carbohydrates from plant sources helps prevent energy dips during the day.",
      quiz: {
        question: "Which nutrients are important to prevent fatigue?",
        options: [
          "Iron, vitamin B12, and complex carbs",
    ...
    {
      issue: "Cancer risk",
      title: "Plant-Based Antioxidants & Fiber",
      content: "Plant-based diets rich in antioxidants, fiber, and phytonutrients help lower the risk of certain cancers.",
      quiz: {
        question: "What nutrients in plant-based diets lower cancer risk?",
        options: [
          "Antioxidants, fiber, and phytonutrients",
          "Processed fats",
          "Sugary foods",
          "Alcohol"
        ],
    ...
    {
      issue: "Cancer risk",
      title: "Reduce Processed Foods & Alcohol",
      content: "Reducing processed meat, alcohol, and fried foods while increasing vegetables, legumes, and whole grains supports long-term cancer prevention.",
      quiz: {
        question: "Which habits support long-term cancer prevention?",
        options: [
          "Reducing processed meat and alcohol, increasing whole plant foods",
          "Eating fried food often",
          "Drinking alcohol daily",
          "Eating only meat"
        ],
        answer: 0
